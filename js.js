...
function Search(){
  alert("Tính năng này đang được phát triển ở website này!")
}
...
//mỗi close là một html colection nên muốn lấy giá trị html thì phải thêm [0]. 
...
function addItemToCart(title, price, img) {
  ...
  // Nếu title của sản phẩm bằng với title mà thêm vao giỏ hàng thì sẽ thông báo đã có sản phẩm rồi .
  ...
  <span class="cart-price cart-column cart-price-color">${price}</span>
  <div class="cart-quantity cart-column">
      <input class="cart-quantity-input" type="number" value="1">
      <i class="btn-danger fa fa-trash-o" aria-hidden="true"></i>
  </div>`
